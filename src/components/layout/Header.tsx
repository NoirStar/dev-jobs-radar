...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 flex h-14 items-center gap-2 border-b bg-background/80 backdrop-blur-lg px-3 md:gap-4 md:px-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <h1 className="hidden text-lg font-bold tracking-tight sm:block">DevJobsRadar</h1>
      </div>
